...
//        'description' => '',
//    ),
    'orderFormTours' => array(
        'file' => 'partsTours/orderFormTours',
        'description' => '',
    ),
    'galleryOuterTours' => array(
        'file' => 'partsTours/galleryOuterTours',
        'description' => '',
    ),
    'galleryItemTours' => array(
        'file' => 'partsTours/galleryItemTours',
        'description' => '',
    ),
);
